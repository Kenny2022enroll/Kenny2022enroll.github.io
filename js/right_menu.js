...
(function () {
    ...
    addEventListener(rm.menuItems.top, 'click', () => flec.toTop() || rm.hideRightMenu());
    ...
    GLOBAL_CONFIG.comment && addEventListener(rm.menuItems.comment, 'click', () => rm.hideRightMenu() || flec.toTalk(selectTextNow));
