document.addEventListener('DOMContentLoaded', function () {
    ...
    function translatePage() {
        if (targetEncoding === 1) {
            ...
            translateButtonObject.firstChild.className = 'flecicon flec-fanti-line'
            utils.snackbarShow('你已切换为简体')
        } else if (targetEncoding === 2) {
            currentEncoding = 2
            targetEncoding = 1
            translateButtonObject.lastChild.textContent = msgToSimplifiedChinese
            translateButtonObject.firstChild.className = 'flecicon flec-jianti-line'
    ...
    function translateInitialization() {
        ...
        if (translateButtonObject) {
            if (currentEncoding !== targetEncoding) {
                ...
                translateButtonObject.firstChild.className = targetEncoding === 1 ? 'flecicon flec-jianti-line' : 'flecicon flec-fanti-line'
                setLang()
