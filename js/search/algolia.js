window.addEventListener("load", () => {
    ...
    const search = instantsearch({
        ...
        searchFunction(helper) {
            if (helper.state.query) {
                let innerLoading = '<i class="flecicon flec-loading-line st-spin"></i>';
    ...
    const pagination = instantsearch.widgets.pagination({
        ...
        showFirstLast: false,
        templates: {
            first: '<i class="flecicon flec-left-two-arrow-line"></i>',
            last: '<i class="flecicon flec-right-two-arrow-line"></i>',
            previous: '<i class="flecicon flec-left-one-arrow-line"></i>',
            next: '<i class="flecicon flec-right-one-arrow-line"></i>',
        },
        cssClasses: {
            root: "pagination",
